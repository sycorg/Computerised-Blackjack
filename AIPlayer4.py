...
def Player():
	...
	while True:
		...
		if decision == 1:
			...
			if handnum[cardno] == 'A' and handtotal > 21:
				...
				print("Player 4 stayed, their turn has now ended")
			if hand2 != "N/A":
			...
			if hand2 != "N/A":
				if nexthand == False:
					nexthand = True
					print("Player 4 has stayed on their first hand.")
				else:
					print("Player 4 has stayed on their second hand. Their Turn has now ended")
					break
			else:
				print("Player 4 has decided to stay, their turn has now ended")
			break
		elif decision == 3:
			print("Player 4 has folded. Their bet has been forfeighted and has been given to the dealer")
			if nexthand == False:
				Fold = True
				if hand2 != "N/A":
					continue
			...
			print("Player 4 has decided to split their hand. Their bet has been doubled then split between their hands")
	...
	print()
	if hand2 == "N/A":
		print(f"Player 4 has {len(hand1)} cards in their hand")
	else:
		print(f"Player 4 has {len(hand1)} cards in their first hand")
		print(f"Player 4 has {len(hand2)} cards in their second hand")
	AI1 = hand1
	if hand2 != "N/A":
		AI2 = hand2
	AIt1 = handtotal
